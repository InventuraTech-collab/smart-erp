...
const ITEMS = [
  { code:'ITM-0001', name:'Cement OPC 50kg',        category:'Construction', unit:'Bags',  stock:1240, value:'AED 62,000', status:'In Stock'  },
  { code:'ITM-0002', name:'Steel Rebar 12mm',        category:'Steel',        unit:'Kg',    stock:8500, value:'AED 42,500', status:'In Stock'  },
  { code:'ITM-0003', name:'Paint Primer White',      category:'Paints',       unit:'Ltrs',  stock:320,  value:'AED 9,600',  status:'In Stock'  },
  { code:'ITM-0004', name:'PVC Pipe 3 inch',         category:'Plumbing',     unit:'Pcs',   stock:45,   value:'AED 2,250',  status:'Low Stock' },
  { code:'ITM-0005', name:'Waterproofing Compound',  category:'Construction', unit:'Pcs',   stock:8,    value:'AED 1,200',  status:'Critical'  },
  { code:'ITM-0006', name:'Tile Adhesive Grey 20kg', category:'Tiles',        unit:'Bags',  stock:25,   value:'AED 1,875',  status:'Low Stock' },
  { code:'ITM-0007', name:'GI Pipe 2 inch',          category:'Plumbing',     unit:'Pcs',   stock:3,    value:'AED 450',    status:'Critical'  },
  { code:'ITM-0008', name:'Sand Fine Grade',         category:'Aggregates',   unit:'Tons',  stock:180,  value:'AED 9,000',  status:'In Stock'  },
]
  ...
  return (
    <ERPLayout>
      ...
      <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr 1fr', gap:14, marginBottom:14 }}>
        ...
        {/* LINE */}
        <div className="sec">
          <div className="sec-hdr" style={{ background: ORANGE }}>📈 Stock Value by Month (AED M)</div>
          <div className="sec-body" style={{ padding:'12px 8px' }}>
